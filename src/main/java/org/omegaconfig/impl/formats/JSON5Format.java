...
public class JSON5Format implements IFormatCodec {
    ...
    private static final char JSON_COMMENT_LINE = '/';
    private static final char JSON_COMMENT_BLOCK = '*';

    @Override public String id() { return OmegaConfig.FORMAT_JSON5; }
    ...
    public static class FormatReader implements IFormatReader {
        ...
        public static final char[] COMMENT = new char[] { JSON_COMMENT_LINE, JSON_COMMENT_BLOCK };
        public static final char[] COMMENT_LINE = new char[] { JSON_COMMENT_LINE };
        ...
        public boolean commentBlock = false;
